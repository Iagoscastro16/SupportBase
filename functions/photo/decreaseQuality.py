...
from photoValidation import type_identify
...
# TODO: antes de chamar decreaseQuality, orquestrar corruption_data() e formats() 
# na rota de upload (ainda não criada)
